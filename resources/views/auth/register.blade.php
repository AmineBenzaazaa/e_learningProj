                            ...
                            <form method="POST" action="{{ route('register') }}">
                                ...
                                <div class="content-box">
                                    <div class="basic-group">
                                        ...
                                        <div class="form-group">
                                            <label for="role"><span class="input-field-icon"><i class="fas fa-users"></i></span> Role:</label>
                                        ...
                                        <div class="form-group">
                                            <label for="password_confirmation"><span class="input-field-icon"><i class="fas fa-lock"></i></span> Repeat Password:</label>
